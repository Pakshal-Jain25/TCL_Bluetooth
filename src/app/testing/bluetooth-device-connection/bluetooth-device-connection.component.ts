...
import { BluetoothConnectionService } from '../../services/bluetooth-connection/bluetooth-connection.service';
import { RouterOutlet } from '@angular/router';
import { MatProgressSpinnerModule } from '@angular/material/progress-spinner';
import { MatButtonModule } from '@angular/material/button';

@Component({
  selector: 'app-bluetooth-device-connection',
  standalone: true,
  imports: [RouterOutlet,MatButtonModule,MatProgressSpinnerModule],
  templateUrl: './bluetooth-device-connection.component.html',
  styleUrl: './bluetooth-device-connection.component.scss'
})
export class BluetoothDeviceConnectionComponent {
  private bluetoothService = inject(BluetoothConnectionService);
